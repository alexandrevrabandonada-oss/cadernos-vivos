# CV — Step B5b: CV2 tokens + V2 layout wrapper

- when: 20260106-124222
- repo: C:\Projetos\Cadernos Vivos\cadernos-vivos

## ACTIONS
- globals.css: added CV2 tokens + base surfaces scoped to .cv-v2.
- Created src/app/c/[slug]/v2/layout.tsx to wrap V2 with .cv-v2.

## BACKUPS
- 20260106-124222-globals.css.bak
...
## NEXT
- B5c: criar componente Card V2 (cv2-card) e padronizar Hub/Provas/Trilhas.