# CV — Fix duplicate JSX props (MapaV2Interactive)

- when: 20260105-184302
- file: `src/components/v2/MapaV2Interactive.tsx`
- tags modified: **0**

## DIAG
- Nenhuma prop duplicada encontrada nas tags JSX deste arquivo.
...
Ô£ô Generating static pages using 11 workers (5/5) in 170.1ms
...
## NEXT
- ✅ Tudo verde. Próximo passo: commit deste bloco e seguimos para Contrato de dados + Zod + fallbacks.