# CV HOTFIX B7I5 — Fix runner do B7I (trocar $args por $cmdArgs)

- Stamp: 20260109-174200
- Root: C:\Projetos\Cadernos Vivos\cadernos-vivos
- npm(cmd): C:\Program Files\nodejs\npm.cmd

## DIAG

- B7I: tools\cv-step-b7i-portals-curated-everywhere-v0_1.ps1

## PATCH

[OK] patched: tools\cv-step-b7i-portals-curated-everywhere-v0_1.ps1
- backup: tools\_patch_backup\20260109-174200\cv-step-b7i-portals-curated-everywhere-v0_1.ps1.20260109-174200.bak
...
Line |
 120 |  . DE -ne 0) { throw ("Command failed: " + $cmd + " " + ($cmdArgs -join  .
     |                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Ô£ô Compiled successfully in 3.6s
  Running TypeScript ...
...
Ô£ô Generating static pages using 11 workers (5/5) in 164.9ms
