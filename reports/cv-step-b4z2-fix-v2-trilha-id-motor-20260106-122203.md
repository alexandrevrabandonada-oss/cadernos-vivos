# CV — Step B4z2: Fix V2 trilhas/[id] to use safe motor

- when: 20260106-122203
- target: src\app\c\[slug]\v2\trilhas\[id]\page.tsx
- backup: 20260106-122203-page.tsx.bak

## ACTIONS
- Removed getCaderno from brace import(s).
- Replaced getCaderno -> loadCadernoV2 (types + calls).
...
Ô£ô Generating static pages using 11 workers (5/5) in 160.6ms
...
## NEXT
- Re-run B4z audit. Expected: zero getCaderno hits in V2 scope.