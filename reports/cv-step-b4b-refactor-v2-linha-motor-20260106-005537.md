# CV — Step B4b: Refactor V2 Linha to use safe motor

- when: 20260106-005537
- target: src\app\c\[slug]\v2\linha\page.tsx
- backup: 20260106-005537-page.tsx.bak
...
Ô£ô Generating static pages using 11 workers (5/5) in 152.8ms
...
## NEXT
- OK. Próximo: B4c (Mapa V2) ou B4c (Linha-do-tempo V2).