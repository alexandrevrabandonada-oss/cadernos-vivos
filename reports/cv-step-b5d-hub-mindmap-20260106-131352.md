# CV — Step B5d: Hub V2 mind-map (nodes + connectors)

- when: 20260106-131352
- repo: C:\Projetos\Cadernos Vivos\cadernos-vivos

## ACTIONS
- globals.css: added mind-map background + connectors for hub cards (scoped to data-cv2-hub="map").
- HomeV2Hub.tsx: ensured container has data-cv2-hub="map" + cv2-hubMap (patched first return tag).

## BACKUPS
- 20260106-131352-globals.css.bak
- 20260106-131352-HomeV2Hub.tsx.bak
...
Ô£ô Generating static pages using 11 workers (5/5) in 165.9ms
...
## NEXT
- B5e: teclado no Hub (setas/enter) + aria-labels onde faltar.