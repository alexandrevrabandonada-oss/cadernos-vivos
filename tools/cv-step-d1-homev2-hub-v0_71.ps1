...
WriteFileLines "src\components\v2\HomeV2.tsx" $homeCompLines
...
# 4) REPORT (sem backticks)
$rep = New-Object System.Collections.Generic.List[string]
$rep.Add("# CV — Step D1 — Home V2 Hub (v0_71)") | Out-Null
$rep.Add("") | Out-Null
...
$rp = WriteReport "cv-step-d1-homev2-hub-v0_71.md" ($rep -join "`n")
