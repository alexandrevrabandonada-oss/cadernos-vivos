# CV — V2 Hotfix — remover eslint-disable-next-line que caiu em JSX (parser error) — v0_10b
...
EnsureDir $reports
$reportPath = Join-Path $reports "cv-v2-hotfix-remove-bad-eslint-comments-v0_10b.md"
$report = @(
  '# CV — Hotfix v0_10b — Parser error (Expression expected)',
  '',
  '## Causa raiz',
