# CV — V2 Tijolo D4 — ProvasV2 (hash focus) — v0_28b
...
WriteReport "cv-v2-tijolo-d4-provas-v2-hashfocus-v0_28b.md" $reportText | Out-Null
Write-Host "[OK] v0_28b aplicado e verificado."