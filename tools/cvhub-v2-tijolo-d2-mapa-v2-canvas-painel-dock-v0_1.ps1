# CV — Tijolo D2 — Mapa V2 (canvas + painel + dock) — v0_1
...
$mapPage = Join-Path $repo "src\app\c\[slug]\v2\mapa\page.tsx"
$mapComp = Join-Path $repo "src\components\v2\MapaV2.tsx"

Write-Host ("[DIAG] page: " + $mapPage)
Write-Host ("[DIAG] comp: " + $mapComp)

# -------------------------
# PATCH: Component (client) — MapaV2
# -------------------------
$bk1 = BackupFile $mapComp
...
WriteUtf8NoBom $mapComp $mapCompText
Write-Host "[OK] wrote: src/components/v2/MapaV2.tsx"
if ($bk1) { Write-Host ("[BK] " + $bk1) }

# -------------------------
# PATCH: Page (server) — /c/[slug]/v2/mapa
# - loader via dynamic import com fallback de nome
# -------------------------
$bk2 = BackupFile $mapPage
...
EnsureDir (Split-Path -Parent $mapPage)
WriteUtf8NoBom $mapPage $pageText
Write-Host "[OK] wrote: src/app/c/[slug]/v2/mapa/page.tsx"
...
EnsureDir $reports
$reportPath = Join-Path $reports "cv-v2-tijolo-d2-mapa-v2-canvas-painel-dock-v0_1.md"

$report = @(
"# CV — Tijolo D2 — Mapa V2 (canvas + painel + dock)",
"",
"## O que foi entregue",
"- Pagina /c/[slug]/v2/mapa com loader robusto (dynamic import e fallback de nome).",
"- Componente MapaV2 client com canvas simples (nodes absolutos), painel lateral e dock de navegacao.",
"",
"## Arquivos",
