# CV — V2 — Hotfix D1: remover "any" nas páginas V2 — v0_1c
...
EnsureDir $reports
$reportPath = Join-Path $reports "cv-v2-hotfix-d1-remove-any-v0_1c.md"
$report = @(
  "# CV — V2 — Hotfix D1 — remover any (ESLint no-explicit-any)",
  "",
  "## Fix",
  "- Removeu `(c as any)` das páginas V2 (Home/Mapa/Debate/Provas).",
...
Write-Host "[OK] Hotfix v0_1c aplicado."