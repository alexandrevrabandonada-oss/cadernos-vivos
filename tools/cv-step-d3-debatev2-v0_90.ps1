...
WriteLines "src\components\v2\DebateV2.tsx" $debateLines

# 2) /v2/debate/page.tsx
$pageLines = @(
...
WriteLines "src\app\c\[slug]\v2\debate\page.tsx" $pageLines
...
$rep.Add("# CV — Step D3 — DebateV2 (v0_90)") | Out-Null
$rep.Add("") | Out-Null
$rep.Add("## O que foi entregue") | Out-Null
$rep.Add("- DebateV2 (client): cards + busca + filtro por ?node= (puxado do mapa via URL).") | Out-Null
$rep.Add("- /v2/debate: carrega loadCadernoV2 e passa debate/mapa (best-effort).") | Out-Null
$rep.Add("") | Out-Null
...
$rp = WriteReport "cv-step-d3-debatev2-v0_90.md" ($rep -join "`n")
