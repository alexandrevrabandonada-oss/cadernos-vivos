...
for ($i=0; $i -lt $lines.Count; $i++) {
  ...
  # só mexe nos campos opcionais que podem virar undefined
...
$rep = @(
  ("# CV V2 Hotfix — normalize no undefined v0.3 — " + $now),
  "",
  "## Problema",
...
$repPath = Join-Path $repDir "cv-v2-hotfix-normalize-no-undefined-v0_3.md"
