...
WriteRel "src\components\v2\HomeV2Hub.tsx" $home
...
$rep.Add("# CV — Fix — HomeV2Hub props mapa/stats (v0_97)") | Out-Null
$rep.Add("") | Out-Null
...
$rep.Add("- Server-safe (sem hooks).") | Out-Null
$rep.Add("") | Out-Null
...
$rp = WriteReport "cv-fix-homev2hub-props-v0_97.md" ($rep -join "`n")
