# CV — V2 Tijolo Infra — Bootstrap + Guards + Verify — v0_19b
...
# --- 5) REPORT ---
$report = @"
# CV — Tijolo Infra v0_19b — Bootstrap + Guards + Verify
...
WriteReport "cv-infra-bootstrap-guards-v0_19b.md" $report | Out-Null
Write-Host "[OK] v0_19b aplicado."